        ...
        return (
          <button
            ...
            className={[
              ...
              active
                ? "border border-[color:var(--accent)] bg-[color:var(--accent)]/15 text-[color:var(--accent)] shadow-[0_0_0_2px_var(--accent-glow)]"
...
function SliderField({
  label, tip, value, min, max, step, suffix, onChange,
}: {
  label: string;
  tip?: React.ReactNode;
  value: number;
    ...
    <div className="oc-glass rounded-xl p-5">
      ...
      <div className="mt-4">
        ...
        <div className="mt-2 flex justify-between text-[11px] text-foreground/50">
          ...
          <span className="tabular-nums text-foreground/70">{value.toFixed(decimals)}{suffix ?? ""}</span>
  ...
  return (
    <main className="min-h-screen bg-background text-foreground">
      <div className="mx-auto max-w-6xl px-4 sm:px-6 py-10 sm:py-16 space-y-8 sm:space-y-10">
        ...
        {/* Header — matches journal / portfolio style */}
        <header>
          <div className="text-xs tracking-[0.22em] text-foreground/40 mb-4">SURVIVABILITY</div>
          <h1 className="text-3xl sm:text-4xl font-semibold tracking-tight">
            <span className="relative inline-block">
              <span className="relative z-10 text-[color:var(--accent)]">50% Drawdown Risk</span>
          ...
          <p className="mt-4 text-sm text-foreground/70">
            ...
            before a volatility-adjusted horizon.
          </p>
        </header>
        ...
        <section className="grid gap-4 sm:grid-cols-2">
          <SliderField
            ...
            min={0.1} max={5} step={0.05} suffix="%"
          ...
          <SliderField
            ...
            value={inputs.avgR}
            min={0.5} max={3} step={0.05} suffix="R"
